...
public class AdjacencyList
{
    ...
    public void setEdge(int source, int destination)
    {
        ...
        System.out.println("It is at source. We are here to test the code ");
        List<Integer> slist = Adjacency_List.get(source);
        slist.add(destination);
       // System.out.println("It is at destination. We are here to test the destination");
    ...
    public static void main(String...arg)
    {
        ...
        try
        {
            ...
            while (count <= number_of_edges) //Giving the edges that are present in the graph.
            {
                source = scan.nextInt();
