/* this program is having pivot at the end. We read input of the array from the given input file. */
import java.io.BufferedReader;
import java.io.File;
import java.io.FileReader;
import java.util.Scanner;

public class QuixkSortCoursera2 {
