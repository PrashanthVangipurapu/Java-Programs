...
public class KargerMicCut {
    ...
    public static void main( String[] args ) {
        int[][] arr = getArray( "F:/books_and_programs/Java_programs/CourseraAlgorithms/CourseraAlgorithms/src/Karger.txt" );
        ...
        for( int i = 0; i < iter; i++ ) {
             System.out.println("In the loop the value of i is  "+i);           
